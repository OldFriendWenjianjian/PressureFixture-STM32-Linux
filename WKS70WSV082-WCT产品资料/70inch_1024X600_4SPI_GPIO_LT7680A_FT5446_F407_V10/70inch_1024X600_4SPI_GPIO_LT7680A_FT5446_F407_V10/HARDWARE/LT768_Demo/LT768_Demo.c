    ...
    {
      {
        for(i=0;i<38;i++)
    	      {
				LT768_DrawSquare_Fill(0,y*38+i,1024,y*38+i+1,color);
				}
      }
		R8=R8+16;
		G8=G8+16;
    ...
    {
      {
        for(i=0;i<19;i++)
    	      {
				LT768_DrawSquare_Fill(0,y*19+i,1024,y*19+i+1,color);
				}
      }
		R8=R8+8;
		G8=G8+8;
    ...
    {
      {
        for(i=0;i<64;i++)
    	      {
				LT768_DrawSquare_Fill(x*64+i,0,x*64+i+1,600,color);
				}
      }
		R8=R8+16;
		G8=G8+16;
    ...
    {
      {
        for(i=0;i<32;i++)
    	      {
				LT768_DrawSquare_Fill(x*32+i,0,x*32+i+1,600,color);
				}
      }
		R8=R8+8;
		G8=G8+8;
...
void display_colorbar_H(void)
{
	...
	LT768_DrawSquare_Fill(0,0,LCD_XSIZE_TFT,100,color16M_red);	
	LT768_DrawSquare_Fill(0,100,LCD_XSIZE_TFT,200,color16M_green);
	LT768_DrawSquare_Fill(0,200,LCD_XSIZE_TFT,300,color16M_blue);
	LT768_DrawSquare_Fill(0,300,LCD_XSIZE_TFT,400,color16M_gray);
	LT768_DrawSquare_Fill(0,400,LCD_XSIZE_TFT,500,color16M_white);
	LT768_DrawSquare_Fill(0,500,LCD_XSIZE_TFT,600,color16M_black);
...
void display_colorbar_V(void)
{
	...
	LT768_DrawSquare_Fill(0,0,170,LCD_YSIZE_TFT,color16M_red);	
	LT768_DrawSquare_Fill(170,0,340,LCD_YSIZE_TFT,color16M_green);
	LT768_DrawSquare_Fill(340,0,510,LCD_YSIZE_TFT,color16M_blue);
	LT768_DrawSquare_Fill(510,0,680,LCD_YSIZE_TFT,color16M_gray);
	LT768_DrawSquare_Fill(680,0,852,LCD_YSIZE_TFT,color16M_white);
	LT768_DrawSquare_Fill(852,0,1024,LCD_YSIZE_TFT,color16M_black);
...
void display_crosstalk(void)
{
	...
	LT768_DrawSquare_Fill(412,200,612,400,color16M_black);
}


void display_HDBK(void)
{
	LT768_DrawSquare_Fill(0,0,LCD_XSIZE_TFT-1,LCD_YSIZE_TFT-1,color16M_white);
	LT768_DrawSquare_Fill(1,1,LCD_XSIZE_TFT-2,LCD_YSIZE_TFT-2,color16M_black);
}



//显示32*30大小棋盘
void display_qipan(void)
{
	u8 i,j;
	for(j=0;j<10;j++)
	{
		for(i=0;i<16;i++)
		{
			LT768_DrawSquare_Fill(64*i,60*j,64*i+32,60*j+30,color16M_white);
			LT768_DrawSquare_Fill(64*i+32,60*j,64*i+64,60*j+30,color16M_black);

			LT768_DrawSquare_Fill(64*i,60*j+30,64*i+32,60*j+60,color16M_black);
			LT768_DrawSquare_Fill(64*i+32,60*j+30,64*i+64,60*j+60,color16M_white);
		}
	}
} 

//显示M*N大小棋盘
void display_qipan1(u8 M, u8 N)
{
	u8 i,j;
	for(j=0;j<LCD_YSIZE_TFT/N/2;j++)
	{
		for(i=0;i<LCD_XSIZE_TFT/M/2;i++)
		{
			LT768_DrawSquare_Fill(M*2*i,N*2*j,M*2*i+M,N*2*j+N,color16M_white);
			LT768_DrawSquare_Fill(M*2*i+M,N*2*j,M*2*i+2*M,N*2*j+M,color16M_black);

			LT768_DrawSquare_Fill(M*2*i,N*2*j+N,M*2*i+M,N*2*j+2*N,color16M_black);
			LT768_DrawSquare_Fill(M*2*i+M,N*2*j+N,M*2*i+2*M,N*2*j+2*N,color16M_white);
		}
	}
}
